...
import { validateTool, isValidModelName, type FixerTool } from '../../shared/config.js';
...
export function createCLI(): Command {
  ...
  program
    ...
    .option('--no-wait-bot', 'Do not wait for bot re-review after push; exit and pick up new comments on next run', false)
